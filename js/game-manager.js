...
class GameManager {
    constructor() {
        ...
        this.transitionData = {
            delivery: { emoji: '🚴‍♂️', tagline: 'Доставь заказ вовремя! Объезжай препятствия' },
            sorting: { emoji: '🧺', tagline: 'Сортируй товары на складе: взять или на склад' },
            finder: { emoji: '🔍', tagline: 'Найди нужный товар среди всех позиций' },
            catcher: { emoji: '📦', tagline: 'Принимай товары на ПВЗ! Лови только нужное' },
            calculator: { emoji: '🧮', tagline: 'Посчитай стоимость заказа быстро и точно' },
            shopping: { emoji: '🛒', tagline: 'Собери заказ по списку на складе' },
            address: { emoji: '🏠', tagline: 'Запомни адрес доставки клиента' },
            weighing: { emoji: '⚖️', tagline: 'Определи категорию веса для доставки' }
        };
