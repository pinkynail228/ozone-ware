...
class FinalNormalGame {
    ...
    showInstructionModal() {
        ...
        if (!modal) {
            ...
            const totalScore = this.gameManager.totalScore || 0;
            scoreBlock.innerHTML = `<span style="font-weight: 700; color: #FFD700;">${totalScore}</span> Озон баллов`;
        ...
        const phrases = [
            `Ты заработал Озон баллы за смену! Отличная работа, но нужно еще лучше. Продолжай совершенствоваться! 💪`,
            `Спасибо за порядок и скорость — ты заработал Озон баллы! В следующую смену постарайся еще лучше! 👏`,
            `Твоя внимательность принесла тебе Озон баллы. Продолжай совершенствоваться и достигай новых высот! ✨`,
            `Смена пролетела, ты заработал Озон баллы. На следующей смене покажи больше результатов! 🚀`,
            `Надёжность принесла тебе Озон баллы. Команда это ценит, но всегда есть куда расти! ❤️`,
            `Ты заработал Озон баллы за свою работу. В следующий раз будет еще лучше, если приложишь больше усилий! 🙌`,
            `Чётко, быстро, по делу — ты заработал Озон баллы! На следующей смене нужно работать еще усерднее! ✅`,
            `Стабильно на 200%. Ты заработал Озон баллы! В следующий раз постарайся выйти на 300%! 🔥`
        ];
